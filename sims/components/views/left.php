...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-shortcuts" id="sidebar-shortcuts">
        <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
            <button class="btn btn-success" id="student_count" title="学生统计">
                <i class="icon-signal"></i>
            </button>

            <button class="btn btn-info" id="notice" title="通知公告">
                <i class="icon-pencil"></i>
            </button>

            <button class="btn btn-warning" id="student_manage" title="学生管理">
        ...
        <script type="text/javascript">
            $("#student_count").click(function(){
                location.href = "<?php echo Url::to(['count-management/student'])?>";
            });
            $("#notice").click(function(){
                location.href = "<?php echo Url::to(['notice/index'])?>";
            });
            $("#student_manage").click(function(){
                location.href = "<?php echo Url::to(['userbc/index'])?>";
            });

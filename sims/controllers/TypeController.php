...
use sims\models\TypeSearch;
use sims\components\CController;
use sims\components\CommonFunction;
...
class TypeController extends CController
{
    ...
    public function init(){
        ...
        $pidlist = Type::find()->where('pid=0')->orderBy('convert(name using gbk)')->asArray()->all();
        $this->pid_list = $function->toKeyValueList($pidlist, 'id', 'name');
    }
